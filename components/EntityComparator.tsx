    ...
    <div className="py-24 bg-slate-900 border-t border-slate-800">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="overflow-x-auto pb-8">
           <div className="min-w-[900px] bg-slate-900 rounded-[3rem] p-8 border border-slate-800 shadow-xl">
              <div className="grid grid-cols-4 gap-6">
                 ...
                 <div className="space-y-6 pt-32">
                    {["Ownership", "Liability", "Min Capital", "Tax Rate", "Govt Tenders", "Activities", "Setup Time"].map((row, i) => (
                      <div key={i} className="h-16 flex items-center text-sm font-black text-slate-500 uppercase tracking-widest border-b border-slate-800">
                         {row}
                      </div>
                    ))}
                 </div>
                 ...
                 <div className="relative group">
                    ...
                    <div className="bg-slate-800 rounded-3xl p-6 shadow-lg border border-slate-700 h-full transition-all flex flex-col hover:border-[rgba(0,108,53,0.3)]">
                       <div className="text-center mb-8">
                          ...
                          <h3 className="text-xl font-black text-white">LLC (MISA)</h3>
                          <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mt-1">Most Popular</p>
                       </div>
                       
                       <div className="space-y-6 flex-1">
                          <div className="h-16 flex items-center justify-center border-b border-slate-700 font-bold text-white">100% Foreign</div>
                          <div className="h-16 flex items-center justify-center border-b border-slate-700 font-bold text-white">Limited</div>
                          <div className="h-16 flex items-center justify-center border-b border-slate-700 font-bold text-slate-500">None*</div>
                          <div className="h-16 flex items-center justify-center border-b border-slate-700 font-bold text-white">20% Profit Tax</div>
                          <div className="h-16 flex items-center justify-center border-b border-slate-700">
                             <Check style={{ color: BRAND.colors.accent }} />
                          </div>
                          <div className="h-16 flex items-center justify-center border-b border-slate-700 font-bold text-sm text-center text-white">All Commercial</div>
                 ...
                 {/* Branch */}
                 <div className="relative group">
                    <div className="bg-slate-800 rounded-3xl p-6 shadow-sm border border-slate-700 h-full hover:shadow-lg transition-all flex flex-col opacity-80 hover:opacity-100">
                       <div className="text-center mb-8">
                          <div className="w-16 h-16 bg-slate-700 rounded-2xl flex items-center justify-center mx-auto mb-4 text-slate-400">
                             <Briefcase size={32} />
                          </div>
                          <h3 className="text-xl font-black text-white">Branch Office</h3>
                          <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mt-1">Project Based</p>
                       </div>
                       
                       <div className="space-y-6 flex-1">
                          <div className="h-16 flex items-center justify-center border-b border-slate-700 font-bold text-white">Parent Co.</div>
                          <div className="h-16 flex items-center justify-center border-b border-slate-700 font-bold" style={{ color: BRAND.colors.alert }}>Unlimited</div>
                          <div className="h-16 flex items-center justify-center border-b border-slate-700 font-bold text-slate-500">None</div>
                          <div className="h-16 flex items-center justify-center border-b border-slate-700 font-bold text-white">20% Profit Tax</div>
                          <div className="h-16 flex items-center justify-center border-b border-slate-700">
                             <Check style={{ color: BRAND.colors.accent }} />
                          </div>
                          <div className="h-16 flex items-center justify-center border-b border-slate-700 font-bold text-sm text-center text-white">Same as Parent</div>
